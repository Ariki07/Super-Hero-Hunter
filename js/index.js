...
function getUrl(){
    ...
    document.getElementById('querySection').innerHTML = 'Showing search results for: '+ searchQuery;

//  Displaying results for entered search query
    if(!searchQuery){
        console.log('Name cannot be empty!');
        return "http://gateway.marvel.com/v1/public/comics?ts=1&apikey=44f9ec71e7a57fab4c39b0bed60558bd&hash=a508c9ce8c11806da2de7069198de748"
    }else{
        return `https://gateway.marvel.com:443/v1/public/characters?nameStartsWith=${searchQuery}&apikey=44f9ec71e7a57fab4c39b0bed60558bd&hash=a508c9ce8c11806da2de7069198de748&ts=1`
    }
}
